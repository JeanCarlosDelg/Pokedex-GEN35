...
const Paginations = ({ page, setPage, maximo }) => {
  ...
  return (
    <div className="pagination-container">
      <button onClick={previousPage} href="!#" className='input__pag'>
        <FaIcons.FaAngleLeft />
      </button>
      <input className='input__pag' value={input} autoComplete='off' name='page' />
